...
const querySnapshot = await getDocs(collection(db, "Italy"));
const data = [];
...
export default function UKList() {
...
const commentsRef = collection(db, 'Italy');
...
const db = getFirestore();
const commentDoc = await getDoc(doc(db, 'Italy', postId));
if (commentDoc.exists()) {
await deleteDoc(doc(db, 'UK', postId));
...
<div className='ItalyHero'>
<div>
  
<h1>Italy: Peninsula of Wonders</h1>
<p>Exploring the Rich Tapestry of Italian Nature, Culture, and Heritage</p>
