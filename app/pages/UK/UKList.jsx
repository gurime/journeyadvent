...
const querySnapshot = await getDocs(collection(db, "UK"));
const data = [];
...
const commentsRef = collection(db, 'UK');
...
const db = getFirestore();
const commentDoc = await getDoc(doc(db, 'UK', postId));
...
<div className='UKHero'>
<div>
  
<h1>The United Kingdom: Archipelago of Wonders</h1>
<p>Exploring the Rich Tapestry of Nature, Culture, and Heritage</p>
