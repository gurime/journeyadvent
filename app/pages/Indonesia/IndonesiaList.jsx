...
const querySnapshot = await getDocs(collection(db, "Indonesia"));
const data = [];
...
const commentsRef = collection(db, 'Indonesia');
...
const db = getFirestore();
const commentDoc = await getDoc(doc(db, 'Indonesia', postId));
if (commentDoc.exists()) {
await deleteDoc(doc(db, 'Indonesia', postId));
